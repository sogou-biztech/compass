...
public class TableRenameVisitorTest 
{
	...
	public void testUnionAll()
	{
		...
		Assert.assertTrue(newSql.equals("(SELECT * FROM cpcplan_01_01) UNION ALL (SELECT * FROM cpc_01_01)"));
	}
	...
	public void testInsertWithSelect()
	{
		...
		String newSql=TableRenameUtil.modifyTableNames(sql, this.tableRenamer);
		System.out.println(newSql);
		Assert.assertTrue(newSql.equals("INSERT INTO cpcplan"+suffix+"(id,name) SELECT id,name FROM cpcplan"+suffix));
	}
	...
	{
		String sql="select CASE WHEN salary <= 500 THEN '1' WHEN salary > 500 AND salary <= 600 THEN '2' ELSE NULL END salary_class from cpcplan ";
		String newSql=TableRenameUtil.modifyTableNames(sql, this.tableRenamer);
		System.out.println(newSql);
		Assert.assertTrue(newSql.equals("SELECT CASE WHEN salary <= 500 THEN '1' WHEN salary > 500 AND salary <= 600 THEN '2' ELSE NULL END salary_class FROM cpcplan"+suffix));
	...
	public void testUpdateTableWithAlia()
	{
		...
		String newSql=TableRenameUtil.modifyTableNames(sql, this.tableRenamer);
		System.out.println(newSql);
		Assert.assertTrue(newSql.equals("UPDATE cpcplan"+this.suffix+" AS cp SET cp.id = 1"));
	}
	...
	public void testLikeEscape(){
		...
		String newSql=TableRenameUtil.modifyTableNames(sql, this.tableRenamer);
		System.out.println(newSql);
		Assert.assertTrue(newSql.equals("SELECT t.name FROM cpcplan"+suffix+" t WHERE t.name LIKE 'gs_' ESCAPE 'S'"));
	}
	...
	public void testMultiValues()
	{
		...
		String newSql=TableRenameUtil.modifyTableNames(sql, this.tableRenamer);
		System.out.println(newSql);
		Assert.assertTrue(newSql.equals("INSERT INTO cpcplan"+suffix+" (id, name) VALUES (1, 'zhangsan1'), (2, 'zhangsan2'), (3, 'zhangsan3')"));
	}
	...
	public void testMultiUpdate()
	{
		...
		String newSql=TableRenameUtil.modifyTableNames(sql, this.tableRenamer);
		System.out.println(newSql);
		Assert.assertTrue(newSql.equals("UPDATE cpcplan"+suffix+" t, cpc"+suffix+" m SET t.id = 1 WHERE t.id = m.id"));
	}
	...
	public void testLeftJoin()
	{
		...
		String newSql=TableRenameUtil.modifyTableNames(sql, this.tableRenamer);
		System.out.println(newSql);
		Assert.assertTrue(newSql.equals("SELECT t.id FROM cpcplan"+suffix+" t LEFT JOIN cpc"+suffix+" m ON t.id = m.id"));
	}
	...
	public void testRightJoin()
	{
		...
		String newSql=TableRenameUtil.modifyTableNames(sql, this.tableRenamer);
		System.out.println(newSql);
		Assert.assertTrue(newSql.equals("SELECT t.id FROM cpcplan"+suffix+" t RIGHT JOIN cpc"+suffix+" m ON t.id = m.id"));
	}
