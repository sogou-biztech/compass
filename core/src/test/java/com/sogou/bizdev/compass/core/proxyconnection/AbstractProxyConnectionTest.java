...
public class AbstractProxyConnectionTest extends TestCase {
    ...
    private AbstractProxyConnection createProxyConnectionForPhysical(final int[] count, final String targetMethodName,
        final Result result, final Object expectValue) {
    ...
    private AbstractProxyConnection createProxyConnectionForRandomAllowed(final int[] count,
        final String targetMethodName, final Object expectValue) {
        return new AbstractProxyConnection() {
            @Override
            protected String getTargetDataSourceNotFoundExceptionErrorMsg() {
                return null;
    ...
    public void testGetSchema() throws Exception {
        ...
        assertEquals(proxyConnection.getSchema(), schema);
    ...
    public void testGetNetworkTimeout() throws Exception {
        ...
        assertEquals(proxyConnection.getNetworkTimeout(), timeout);
        assertTrue(count[0] == 1 && count[1] == 1);
    }
