...
public abstract class AbstractProxyConnection implements Connection {
    ...
    protected Connection getPhysicalOrRandomConnection() throws SQLException {
        ...
        throw new TargetDataSourceNotFoundException("getPhysicalOrRandomConnection error, "
            + this.getTargetDataSourceNotFoundExceptionErrorMsg());
    }
    ...
    protected Connection getOrCreatePhysicalConnection() throws SQLException {
        ...
        if (connection == null) {
            throw new TargetDataSourceNotFoundException("getOrCreatePhysicalConnection error, "
                + this.getTargetDataSourceNotFoundExceptionErrorMsg());
        }
    ...
    public CallableStatement prepareCall(String sql) throws SQLException {
        if (this.useRandomConnection) {
            throw new TargetDataSourceNotFoundException("prepareCall error, "
                + this.getTargetDataSourceNotFoundExceptionErrorMsg());
        }
    ...
    public void setAutoCommit(boolean autoCommit) throws SQLException {
        if (this.useRandomConnection) {
            throw new TargetDataSourceNotFoundException("setAutoCommit error, "
                + this.getTargetDataSourceNotFoundExceptionErrorMsg());
        }
    ...
    public void commit() throws SQLException {
        if (this.useRandomConnection) {
            throw new TargetDataSourceNotFoundException("commit error, "
                + this.getTargetDataSourceNotFoundExceptionErrorMsg());
        }
    ...
    public void rollback() throws SQLException {
        if (this.useRandomConnection) {
            throw new TargetDataSourceNotFoundException("rollback error, "
                + this.getTargetDataSourceNotFoundExceptionErrorMsg());
        }
    ...
    public void setTransactionIsolation(int level) throws SQLException {
        if (this.useRandomConnection) {
            throw new TargetDataSourceNotFoundException("setTransactionIsolation error, "
                + this.getTargetDataSourceNotFoundExceptionErrorMsg());
        }
    ...
    public Savepoint setSavepoint() throws SQLException {
        if (this.useRandomConnection) {
            throw new TargetDataSourceNotFoundException("setSavepoint error, "
                + this.getTargetDataSourceNotFoundExceptionErrorMsg());
        }
    ...
    public void releaseSavepoint(Savepoint savepoint) throws SQLException {
        if (this.useRandomConnection) {
            throw new TargetDataSourceNotFoundException("releaseSavepoint error, "
                + this.getTargetDataSourceNotFoundExceptionErrorMsg());
        }
    ...
    public Statement createStatement() throws SQLException {
        if (this.useRandomConnection) {
            throw new TargetDataSourceNotFoundException("createStatement error, "
                + this.getTargetDataSourceNotFoundExceptionErrorMsg());
        }
    ...
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        if (this.useRandomConnection) {
            throw new TargetDataSourceNotFoundException("prepareStatement error, "
                + this.getTargetDataSourceNotFoundExceptionErrorMsg());
        }
        return this.getOrCreatePhysicalConnection().prepareStatement(sql);
    }
    ...
    public void setReadOnly(boolean readOnly) throws SQLException {
        if (this.useRandomConnection) {
            throw new TargetDataSourceNotFoundException("setReadOnly error, "
                + this.getTargetDataSourceNotFoundExceptionErrorMsg());
        }
    ...
    public void setCatalog(String catalog) throws SQLException {
        if (this.useRandomConnection) {
            throw new TargetDataSourceNotFoundException("setCatalog error, "
                + this.getTargetDataSourceNotFoundExceptionErrorMsg());
        }
    ...
    public void setTypeMap(Map<String, Class<?>> map) throws SQLException {
        if (this.useRandomConnection) {
            throw new TargetDataSourceNotFoundException("setTypeMap error, "
                + this.getTargetDataSourceNotFoundExceptionErrorMsg());
        }
    ...
    public void setHoldability(int holdability) throws SQLException {
        if (this.useRandomConnection) {
            throw new TargetDataSourceNotFoundException("setHoldability error, "
                + this.getTargetDataSourceNotFoundExceptionErrorMsg());
        }
    ...
    public void setClientInfo(String name, String value) throws SQLClientInfoException {
        if (this.useRandomConnection) {
            throw new TargetDataSourceNotFoundException("setClientInfo error, "
                + this.getTargetDataSourceNotFoundExceptionErrorMsg());
        }
        try {
    ...
    public Clob createClob() throws SQLException {
        if (this.useRandomConnection) {
            throw new TargetDataSourceNotFoundException("createClob error, "
                + this.getTargetDataSourceNotFoundExceptionErrorMsg());
        }
    ...
    public Blob createBlob() throws SQLException {
        if (this.useRandomConnection) {
            throw new TargetDataSourceNotFoundException("createBlob error, "
                + this.getTargetDataSourceNotFoundExceptionErrorMsg());
        }
    ...
    public NClob createNClob() throws SQLException {
        if (this.useRandomConnection) {
            throw new TargetDataSourceNotFoundException("createNClob error, "
                + this.getTargetDataSourceNotFoundExceptionErrorMsg());
        }
    ...
    public SQLXML createSQLXML() throws SQLException {
        if (this.useRandomConnection) {
            throw new TargetDataSourceNotFoundException("createSQLXML error, "
                + this.getTargetDataSourceNotFoundExceptionErrorMsg());
        }
    ...
    public Array createArrayOf(String typeName, Object[] elements) throws SQLException {
        if (this.useRandomConnection) {
            throw new TargetDataSourceNotFoundException("createArrayOf error, "
                + this.getTargetDataSourceNotFoundExceptionErrorMsg());
        }
    ...
    public Struct createStruct(String typeName, Object[] attributes) throws SQLException {
        if (this.useRandomConnection) {
            throw new TargetDataSourceNotFoundException("createStruct error, "
                + this.getTargetDataSourceNotFoundExceptionErrorMsg());
        }
    ...
    public void setSchema(String schema) throws SQLException {
        if (this.useRandomConnection) {
            throw new TargetDataSourceNotFoundException("setSchema error, "
                + this.getTargetDataSourceNotFoundExceptionErrorMsg());
        }
        JdbcMethodUtils.invokeJdbcMethod(Connection.class, "setSchema", new Class<?>[]{String.class},
            getOrCreatePhysicalConnection(), new Object[]{schema});
    }

    public void setNetworkTimeout(Executor executor, int milliseconds) throws SQLException {
        if (this.useRandomConnection) {
            throw new TargetDataSourceNotFoundException("setNetworkTimeout error, "
                + this.getTargetDataSourceNotFoundExceptionErrorMsg());
        }
        JdbcMethodUtils.invokeJdbcMethod(Connection.class, "setNetworkTimeout",
            new Class<?>[]{Executor.class, int.class},
            getOrCreatePhysicalConnection(),
    ...
    public String getSchema() throws SQLException {
        return (String) JdbcMethodUtils.invokeJdbcMethod(Connection.class, "getSchema", new Class<?>[0],
            getPhysicalOrRandomConnection(), new Object[0]);
    }

    public void abort(Executor executor) throws SQLException {
        JdbcMethodUtils.invokeJdbcMethod(Connection.class, "abort", new Class<?>[]{Executor.class},
            getPhysicalOrRandomConnection(), new Object[]{executor});
    }

    public int getNetworkTimeout() throws SQLException {
        return (Integer) JdbcMethodUtils.invokeJdbcMethod(Connection.class, "getNetworkTimeout", new Class<?>[0],
            getPhysicalOrRandomConnection(), new Class<?>[0]);
    }
