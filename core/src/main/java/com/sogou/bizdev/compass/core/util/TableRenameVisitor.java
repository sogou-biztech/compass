 ...
 */
public class TableRenameVisitor implements SelectVisitor, FromItemVisitor, ExpressionVisitor, ItemsListVisitor,
    ...
    public TableRenameVisitor(TableRenamer tableRenamer) {
